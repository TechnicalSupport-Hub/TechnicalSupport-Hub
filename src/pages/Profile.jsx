...
function ProfileContent({ profile, auth, updateProfile, logout, navigate }) {
    ...
    <main className="w-full flex-1">
      <div className="mx-auto w-full max-w-3xl px-5 py-10 sm:px-8 sm:py-14">
        <div className="mb-6 flex items-center justify-between">
          <button
            type="button"
            onClick={() => navigate(auth.role === "admin" ? "/admin" : "/faq")}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-400">
                  {profile.email || auth.email || "user@company.com"}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="border-b border-gray-100 pb-4">
            ...
            <p className="mt-1 text-xs text-gray-500">
              Update your account details and contact information stored in Supabase.
            </p>
          </div>
...
export default function Profile() {
  ...
  return (
    <ProfileContent
      key={profile.email || auth.id || "profile-default"}
      profile={profile}
      auth={auth}
